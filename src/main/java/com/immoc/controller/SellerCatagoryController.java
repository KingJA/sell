...
@Slf4j
public class SellerCatagoryController {
    @Autowired
    ...
    public ModelAndView save(@Valid CategoryForm categoryForm, BindingResult bindingResult, Map<String, Object> map) {
        if (bindingResult.hasFieldErrors()) {
            ...
            map.put("url", "/sell/seller/product/index?categoryId=" + categoryForm.getCategoryId());
        ...
        try {
            ...
            map.put("url", "/sell/seller/product/?categoryId=" + categoryForm.getCategoryId());
            return new ModelAndView("common/error", map);
        }
